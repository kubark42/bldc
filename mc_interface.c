...
__attribute__((section(".ram4"))) static volatile int32_t m_frf_samples[ADC_SAMPLE_MAX_LEN][1];
...
//				m_phase_samples[m_sample_now] = (uint8_t)(ang / 360.0 * 250.0);
			...
			if (1) {
				m_curr_fir_samples[m_sample_now] = (int16_t)(mcpwm_foc_get_vd() * 1000 + 0.5);
